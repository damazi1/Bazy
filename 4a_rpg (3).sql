...
--
-- Host: 127.0.0.1
-- Czas generowania: 13 Wrz 2021, 08:55
...
--
-- Indeksy dla tabeli `lokacje_budynki`
--
ALTER TABLE `lokacje_budynki`
  ADD KEY `id_budynki` (`id_budynki`),
  ADD KEY `id_lokacja` (`id_lokacja`);

--
-- Indeksy dla tabeli `lokacje_wrogowie`
--
ALTER TABLE `lokacje_wrogowie`
  ADD KEY `id_wrogowie` (`id_wrogowie`),
  ADD KEY `id_lokacja` (`id_lokacja`);
...
ALTER TABLE `npc`
  ...
  ADD KEY `rola_w_grze` (`rola_w_grze`);
...
ALTER TABLE `regiony (geograficzne)`
  ...
  ADD KEY `przewazajaca_rasa` (`przewazajaca_rasa`),
  ADD KEY `znienawidzona_rasa` (`znienawidzona_rasa`),
  ADD KEY `wladca` (`wladca`);
...
--
ALTER TABLE `regiony (geograficzne)`
  MODIFY `id_regiony` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
ALTER TABLE `budynki`
  ...
  ADD CONSTRAINT `budynki_ibfk_2` FOREIGN KEY (`wlasciciel`) REFERENCES `npc` (`id_dane_npc`);
...
ALTER TABLE `ekwipunek`
  ...
  ADD CONSTRAINT `ekwipunek_ibfk_4` FOREIGN KEY (`id_gracz`) REFERENCES `gracze` (`id_dane_graczy`),
  ADD CONSTRAINT `ekwipunek_ibfk_5` FOREIGN KEY (`id_npc`) REFERENCES `npc` (`id_dane_npc`),
...
--
ALTER TABLE `lokacje`
  ADD CONSTRAINT `lokacje_ibfk_1` FOREIGN KEY (`region`) REFERENCES `regiony (geograficzne)` (`id_regiony`);

--
-- Ograniczenia dla tabeli `lokacje_budynki`
--
ALTER TABLE `lokacje_budynki`
  ADD CONSTRAINT `lokacje_budynki_ibfk_1` FOREIGN KEY (`id_budynki`) REFERENCES `budynki` (`id_budynki`),
  ADD CONSTRAINT `lokacje_budynki_ibfk_2` FOREIGN KEY (`id_lokacja`) REFERENCES `lokacje` (`id_lokacje`);

--
-- Ograniczenia dla tabeli `lokacje_wrogowie`
--
ALTER TABLE `lokacje_wrogowie`
  ADD CONSTRAINT `lokacje_wrogowie_ibfk_1` FOREIGN KEY (`id_wrogowie`) REFERENCES `npc` (`id_dane_npc`),
  ADD CONSTRAINT `lokacje_wrogowie_ibfk_2` FOREIGN KEY (`id_lokacja`) REFERENCES `lokacje` (`id_lokacje`);

--
-- Ograniczenia dla tabeli `npc`
--
ALTER TABLE `npc`
  ADD CONSTRAINT `npc_ibfk_1` FOREIGN KEY (`rasa`) REFERENCES `rasy` (`id_rasy`),
  ADD CONSTRAINT `npc_ibfk_2` FOREIGN KEY (`charakter`) REFERENCES `charaktery` (`id_charaktery`),
  ADD CONSTRAINT `npc_ibfk_3` FOREIGN KEY (`wyznawane_bostwo`) REFERENCES `bóstwa` (`id_bostwa`),
  ADD CONSTRAINT `npc_ibfk_4` FOREIGN KEY (`nastawienie_do_innych_postaci`) REFERENCES `charaktery` (`id_charaktery`),
  ADD CONSTRAINT `npc_ibfk_5` FOREIGN KEY (`rola_w_grze`) REFERENCES `role postaci` (`id_role_postaci`);

--
-- Ograniczenia dla tabeli `rasy`
--
ALTER TABLE `rasy`
  ADD CONSTRAINT `rasy_ibfk_1` FOREIGN KEY (`id_rasy`) REFERENCES `regiony (geograficzne)` (`przewazajaca_rasa`);

--
-- Ograniczenia dla tabeli `regiony (geograficzne)`
--
ALTER TABLE `regiony (geograficzne)`
  ADD CONSTRAINT `regiony (geograficzne)_ibfk_1` FOREIGN KEY (`przewazajaca_rasa`) REFERENCES `rasy` (`id_rasy`),
  ADD CONSTRAINT `regiony (geograficzne)_ibfk_2` FOREIGN KEY (`znienawidzona_rasa`) REFERENCES `rasy` (`id_rasy`),
  ADD CONSTRAINT `regiony (geograficzne)_ibfk_3` FOREIGN KEY (`wladca`) REFERENCES `npc` (`id_dane_npc`);
COMMIT;
